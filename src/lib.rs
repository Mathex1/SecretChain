...
#[derive(Debug)]
pub struct SecretChainProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SecretChainProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SecretChain processing");
    
    let mut processor = SecretChainProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SecretChainProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SecretChainProcessor::new(false);
